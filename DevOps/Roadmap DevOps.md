...
Большинство серверов и сетевых устройств работают на [Linux](https://kernel.org/) (хотя встречаются и другие Unix-подобные ОС). Поэтому путь в DevOps стоит начать именно с подробного изучения Linux.
...
Бесплатный курс [Git для начинающих](https://slurm.io/git?utm_medium=article&utm_source=habr&utm_campaign=roadmap). В нём рассматривается бо́льшая часть из этого списка.
